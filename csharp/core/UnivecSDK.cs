...
using UnivecSdk.Feature;

namespace UnivecSdk;

public class UnivecSDK
{
    ...
    public UnivecSDK(Dictionary<string, object?>? options = null)
    {
        ...
        var config = global::UnivecSdk.SdkConfig.SharedConfig();
        ...
        // the chain.
        var featureOpts = global::UnivecSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(_options, "feature"))
        ...
        foreach (var fnameObj in featureOrder)
        {
            ...
            var fopts = global::UnivecSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(featureOpts, fname));
            if (fopts != null &&
                fopts.TryGetValue("active", out var active) &&
                active is bool ab && ab)
            {
                _utility.FeatureAdd(_rootctx, global::UnivecSdk.SdkConfig.MakeFeature(fname));
            }
        }
    ...
    {
        return global::UnivecSdk.Utility.Copy(_utility);
    }
    ...
    public Dictionary<string, object?> Prepare(Dictionary<string, object?>? fetchargs)
    {
        ...
        var ctrl = global::UnivecSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "ctrl"))
            ?? new Dictionary<string, object?>();
        ...
        var pathParams = global::UnivecSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "params"))
            ?? new Dictionary<string, object?>();
        var query = global::UnivecSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "query"))
            ?? new Dictionary<string, object?>();
    ...
    private Dictionary<string, object?> OpDenied(string op)
    {
        ...
        {
            ["ok"] = false,
            ["err"] = new Exception("UnivecSDK: " + op +
    ...
    private Dictionary<string, object?> RawRequest(Dictionary<string, object?>? fetchargs)
    {
        ...
        {
            var status = global::UnivecSdk.Helpers.ToInt(global::Voxgig.Struct.StructUtils.GetProp(fm, "status"));
        ...
        Dictionary<string, object?>? ctrl = null)
    {
        ...
        if (null != errors && 0 < errors.Count)
        {
            ...
            res["ok"] = false;
            res["err"] = new Exception("UnivecSDK: graphql: " + msg);
            res["graphql"] = errors;
        }
    ...
    // Idiomatic usage: client.Convert().List(null) or
    // client.Convert().Load(new() { ["id"] = ... }).
    public UnivecEntityBase Convert(Dictionary<string, object?>? entopts = null)
    {
        return new global::UnivecSdk.Entity.ConvertEntity(this, entopts);
    }

    // Embed returns a Embed entity bound to this client.
    // Idiomatic usage: client.Embed().List(null) or
    // client.Embed().Load(new() { ["id"] = ... }).
    public UnivecEntityBase Embed(Dictionary<string, object?>? entopts = null)
    {
        return new global::UnivecSdk.Entity.EmbedEntity(this, entopts);
    }

    // EphemeralKey returns a EphemeralKey entity bound to this client.
    // Idiomatic usage: client.EphemeralKey().List(null) or
    // client.EphemeralKey().Load(new() { ["id"] = ... }).
    public UnivecEntityBase EphemeralKey(Dictionary<string, object?>? entopts = null)
    {
        return new global::UnivecSdk.Entity.EphemeralKeyEntity(this, entopts);
    }

    // Model returns a Model entity bound to this client.
    // Idiomatic usage: client.Model().List(null) or
    // client.Model().Load(new() { ["id"] = ... }).
    public UnivecEntityBase Model(Dictionary<string, object?>? entopts = null)
    {
        return new global::UnivecSdk.Entity.ModelEntity(this, entopts);
    }


    public static UnivecSDK TestSDK(Dictionary<string, object?>? testopts,
