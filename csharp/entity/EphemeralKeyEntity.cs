...
namespace UnivecSdk.Entity;

public class EphemeralKeyEntity : UnivecEntityBase
{
    public EphemeralKeyEntity(UnivecSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "ephemeral_key")
    {
    }

    public override IEntity Make()
    {
        return new EphemeralKeyEntity(client, CloneOpts());
    }
