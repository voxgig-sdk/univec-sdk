...
public class ConvertEntity : UnivecEntityBase
{
    public ConvertEntity(UnivecSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "convert")
    {
    }

    public override IEntity Make()
    {
        return new ConvertEntity(client, CloneOpts());
    }
