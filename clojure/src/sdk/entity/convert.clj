...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "convert" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Convert client data) accessor delegates here.
...
;; Create a new Convert (reqdata: body data).
