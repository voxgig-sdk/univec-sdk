...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "embed" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Embed client data) accessor delegates here.
...
;; Create a new Embed (reqdata: body data).
