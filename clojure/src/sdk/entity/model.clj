;; Univec SDK Model entity (generated by @voxgig/sdkgen).
(ns sdk.entity.model
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "model" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Model client data) accessor delegates here.
...
;; List Model items matching a filter (reqmatch: any subset of fields).
