;; Univec SDK EphemeralKey entity (generated by @voxgig/sdkgen).
(ns sdk.entity.ephemeral_key
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "ephemeral_key" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_deleted deleted :_entctx entctx
             :get-name (fn [] "ephemeral_key")
...
;; Canonical facade: (EphemeralKey client data) accessor delegates here.
...
;; Create a new EphemeralKey (reqdata: body data).
