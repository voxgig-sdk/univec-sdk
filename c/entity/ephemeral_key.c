// EphemeralKey entity client (generated — mirrors the rust Entity fragment).
...
typedef struct ephemeral_key_entity {
  ...
  bool deleted;
} ephemeral_key_entity;

typedef void (*ephemeral_key_postdone_fn)(ephemeral_key_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT ephemeral_key_VT;
static const char* ephemeral_key_get_name(Entity* e);
static Entity* ephemeral_key_make(Entity* e);
static voxgig_value* ephemeral_key_data(Entity* e, voxgig_value* args);
static voxgig_value* ephemeral_key_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* ephemeral_key_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** ephemeral_key_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* ephemeral_key_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* ephemeral_key_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* ephemeral_key_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void ephemeral_key_mark_deleted(Entity* e);
static bool ephemeral_key_deleted(Entity* e);

static Context* ephemeral_key_ent_ctx(ephemeral_key_entity* self) {
  return self->entctx;
}
...
Entity* ephemeral_key_entity_new(UnivecSDK* client, voxgig_value* entopts) {
  ...
  ephemeral_key_entity* self = (ephemeral_key_entity*)calloc(1, sizeof(ephemeral_key_entity));
  self->base.vt = &ephemeral_key_VT;
  self->name = strdup("ephemeral_key");
  self->client = client;
...
static voxgig_value* ephemeral_key_run_op(ephemeral_key_entity* self, Context* ctx,
                                    ephemeral_key_postdone_fn post_done, PNError** err) {
...
voxgig_value* ephemeral_key_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  ephemeral_key_entity* self = (ephemeral_key_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, ephemeral_key_ent_ctx(self));
...
static const char* ephemeral_key_get_name(Entity* e) {
  return ((ephemeral_key_entity*)e)->name;
}
...
static Entity* ephemeral_key_make(Entity* e) {
  ...
  return ephemeral_key_entity_new(self->client, opts);
}
...
static voxgig_value* ephemeral_key_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(ephemeral_key_ent_ctx(self), "SetData");
  }
  feature_hook_util(ephemeral_key_ent_ctx(self), "GetData");
...
static voxgig_value* ephemeral_key_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(ephemeral_key_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(ephemeral_key_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static Entity* ephemeral_key_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "ephemeral_key");
  return NULL;
}

static Entity** ephemeral_key_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "ephemeral_key");
  return NULL;
}


static void ephemeral_key_create_postdone(ephemeral_key_entity* self, Context* ctx) {
...
static Entity* ephemeral_key_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, ephemeral_key_ent_ctx(self));
  ephemeral_key_run_op(self, ctx, ephemeral_key_create_postdone, err);
  if (*err) return NULL;
...
static Entity* ephemeral_key_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "ephemeral_key");
  return NULL;
}

static Entity* ephemeral_key_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "ephemeral_key");
  return NULL;
}
...
// live record.
static void ephemeral_key_mark_deleted(Entity* e) {
  ((ephemeral_key_entity*)e)->deleted = true;
}

static bool ephemeral_key_deleted(Entity* e) {
  return ((ephemeral_key_entity*)e)->deleted;
}

static const EntityVT ephemeral_key_VT = {
  ephemeral_key_get_name,
  ephemeral_key_make,
  ephemeral_key_data,
  ephemeral_key_matchv,
  ephemeral_key_mark_deleted,
  ephemeral_key_deleted,
  ephemeral_key_load,
  ephemeral_key_list,
  ephemeral_key_create,
  ephemeral_key_update,
  ephemeral_key_remove,
};
