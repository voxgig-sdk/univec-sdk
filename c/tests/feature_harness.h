// Behavioural feature-test harness for the Univec SDK (C port of the
...
#ifndef UNIVEC_FEATURE_HARNESS_H
#define UNIVEC_FEATURE_HARNESS_H
...
#endif // UNIVEC_FEATURE_HARNESS_H
