...
func registerSDKWords(r *eng.Registry, client *sdk.UnivecSDK) {
...
func runOp(client *sdk.UnivecSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
