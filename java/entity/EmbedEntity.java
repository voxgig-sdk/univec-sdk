...
public class EmbedEntity extends EntityBase {

  public EmbedEntity(SdkClient client, Map<String, Object> entopts) {
    super("embed", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EmbedEntity(this.client, opts);
  }
