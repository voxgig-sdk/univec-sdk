...
public class EphemeralKeyEntity extends EntityBase {

  public EphemeralKeyEntity(SdkClient client, Map<String, Object> entopts) {
    super("ephemeral_key", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EphemeralKeyEntity(this.client, opts);
  }
