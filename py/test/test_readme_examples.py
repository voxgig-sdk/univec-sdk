# Univec SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UnivecSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UnivecSDK(...) and UnivecSDK.test(...) become
#      UnivecSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "univec_sdk"
_SDK_CLASS = "UnivecSDK"
