...
from univec_sdk.utility import register

# Load features
from univec_sdk.feature.base_feature import UnivecBaseFeature
from univec_sdk.features import _has_feature, _make_feature
...
class UnivecSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UnivecSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Convert(self, data=None) -> "ConvertEntity":
        ...
        from univec_sdk.entity.convert_entity import ConvertEntity
        return ConvertEntity(self, data)


    def Embed(self, data=None) -> "EmbedEntity":
        """Entity factory: client.Embed().list() / client.Embed().load({"id": ...})."""
        from univec_sdk.entity.embed_entity import EmbedEntity
        return EmbedEntity(self, data)


    def EphemeralKey(self, data=None) -> "EphemeralKeyEntity":
        """Entity factory: client.EphemeralKey().list() / client.EphemeralKey().load({"id": ...})."""
        from univec_sdk.entity.ephemeral_key_entity import EphemeralKeyEntity
    ...
    def Model(self, data=None) -> "ModelEntity":
        ...
        from univec_sdk.entity.model_entity import ModelEntity
        return ModelEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "UnivecSDK":
        if sdkopts is None:
            sdkopts = {}
