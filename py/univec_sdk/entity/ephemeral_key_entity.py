...
from univec_sdk.univec_types import (
    EphemeralKey,
...
class EphemeralKeyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EphemeralKeyEntity(self._client, opts)
    ...
    def data_get(self) -> EphemeralKey:
    ...
    def match_get(self) -> EphemeralKey:
    ...
    def create(self, reqdata: EphemeralKeyCreateData, ctrl=None) -> EphemeralKey:
        utility = self._utility
