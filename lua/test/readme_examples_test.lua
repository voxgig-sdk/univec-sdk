...
-- data to return.
local TEST_SEED = '{ entity = { ["convert"] = { ["test01"] = { id = "test01" } }, ["embed"] = { ["test01"] = { id = "test01" } }, ["ephemeral_key"] = { ["test01"] = { id = "test01" } }, ["model"] = { ["test01"] = { id = "test01" } } } }'
