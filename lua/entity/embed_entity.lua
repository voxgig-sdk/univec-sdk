...
local EmbedEntity = {}
EmbedEntity.__index = EmbedEntity


function EmbedEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmbedEntity)
  self._name = "embed"
  self._client = client
...
function EmbedEntity:get_name()
  return self._name
end


function EmbedEntity:make()
  local opts = {}
...
function EmbedEntity:mark_deleted()
  self._deleted = true
end


function EmbedEntity:deleted()
  return true == self._deleted
end


function EmbedEntity:data_set(args)
  if args ~= nil then
...
function EmbedEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmbedEntity:match_set(args)
  if args ~= nil then
...
function EmbedEntity:match_get()
...
function EmbedEntity:stream(action, args, callopts)
...
---@param reqdata EmbedCreateData
---@param ctrl? table
---@return Embed
---@return string? err
function EmbedEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function EmbedEntity:_run_op(ctx, post_done)
  local utility = self._utility
