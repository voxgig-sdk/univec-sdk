#!perl
# Univec SDK - documentation example COMPLETENESS gate.
#
...
#      (UnivecSDK->test) against the real SDK. Captured output is scanned for
...
# becomes UnivecSDK->test(<fixtures>); a block that only uses $client gets
