// EphemeralKey entity client (generated). Shared entity runtime (data/match
...
class EphemeralKeyEntity : public EntityBase {
public:
  EphemeralKeyEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("ephemeral_key", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EphemeralKeyEntity>(this->client, opts);
  }
