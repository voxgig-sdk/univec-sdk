// Embed entity client (generated). Shared entity runtime (data/match
...
class EmbedEntity : public EntityBase {
public:
  EmbedEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("embed", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<EmbedEntity>(this->client, opts);
  }
