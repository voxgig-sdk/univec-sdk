...
class ModelEntity
  ...
  # @return [Model, Hash] the current Model data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Model fields)
  def match_get
  ...
  #
  # @param reqmatch [ModelListMatch, Hash, nil] match filter (any subset of
  #   Model fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Model>, Array] the matching Model items; raises UnivecError on failure
