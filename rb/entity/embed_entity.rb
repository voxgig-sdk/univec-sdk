...
class EmbedEntity
  ...
  # @return [Embed, Hash] the current Embed data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Embed fields)
  def match_get
  ...
  # Create a new Embed.
  #
  # @param reqdata [EmbedCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Embed, Hash] the created Embed; raises UnivecError on failure
