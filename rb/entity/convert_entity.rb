...
class ConvertEntity
  ...
  def make
    opts = @_entopts.dup
    ConvertEntity.new(@_client, opts)
  end
  ...
  # @return [Convert, Hash] the current Convert data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Convert fields)
  def match_get
  ...
  #
  # @param reqdata [ConvertCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Convert, Hash] the created Convert; raises UnivecError on failure
