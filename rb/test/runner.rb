...
module UnivecTestRunner
  ...
  def self.env_override(m)
    live = getenv("UNIVEC_TEST_LIVE")
    override = getenv("UNIVEC_TEST_OVERRIDE")
    ...
    explain = getenv("UNIVEC_TEST_EXPLAIN")
    m["UNIVEC_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = UnivecTestRunner
Helpers = UnivecHelpers
Vs = VoxgigStruct
