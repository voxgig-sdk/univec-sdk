...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = UnivecOmni.make_runner(TEST_JSON_FILE, UnivecSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : UnivecOmni.errify(err)
    end
