...
from projectname_sdk import UnivecSDK
from projectname_sdk.core.spec import UnivecSpec
from projectname_sdk.core.result import UnivecResult
from projectname_sdk.core.response import UnivecResponse
from projectname_sdk.core.operation import UnivecOperation
from projectname_sdk.core.error import UnivecError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import UnivecBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = UnivecSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = UnivecSDK.test(None, None)
        ...
        class TestInitFeature(UnivecBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(UnivecBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = UnivecSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = UnivecSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = UnivecSDK.test(None, setup_opts)
