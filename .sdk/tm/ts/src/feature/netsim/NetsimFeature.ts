...
class NetsimFeature extends BaseFeature {
  ...
  async _simulate(this: any, ctx: any, url: string, fetchdef: any, inner: any): Promise<any> {
  ...
  _track(this: any, ctx: any, applied: any) {
  ...
  _respond(this: any, ctx: any, status: number, data?: any, extra?: any): any {
    ...
    const headers: any = struct.getprop(out, 'headers', {})
    out.headers = {
      get(key: string) {
