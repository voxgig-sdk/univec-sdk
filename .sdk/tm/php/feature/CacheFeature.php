...
class UnivecCacheFeature extends UnivecBaseFeature
{
    ...
    private function _through(UnivecContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
