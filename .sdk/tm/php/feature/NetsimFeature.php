...
class UnivecNetsimFeature extends UnivecBaseFeature
{
    ...
    private function _simulate(UnivecContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UnivecContext $ctx, array $applied): void
    {
        $client = $this->client;
