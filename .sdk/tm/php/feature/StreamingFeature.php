...
class UnivecStreamingFeature extends UnivecBaseFeature
{
    ...
    private function _iterate(UnivecResult $result): \Generator
    {
    ...
    private function _streamable(UnivecContext $ctx): bool
    {
