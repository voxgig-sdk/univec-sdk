...
class UnivecRetryFeature extends UnivecBaseFeature
{
    ...
    private function _with_retry(UnivecContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(UnivecContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
