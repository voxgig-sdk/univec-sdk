...
// Univec SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UnivecOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UnivecOmni::structfix($now, Struct::undef()))
                        !== json_encode(UnivecOmni::structfix($val, Struct::undef()))) {
