...
|---|---|---|
| `js/` | @voxgig-sdk/univec-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/univec | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/univec-js \
      --repository voxgig-sdk/univec-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/univec-js` shows it, and
`npm trust revoke @voxgig-sdk/univec-js --id=<id>` removes it.
