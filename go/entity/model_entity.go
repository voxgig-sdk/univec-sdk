...
func NewModelEntity(client *core.UnivecSDK, entopts map[string]any) *ModelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ModelEntity) GetName() string { return e.name }
...
func (e *ModelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ModelEntity) Deleted() bool {
	return e.deleted
}


func (e *ModelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewModelEntity(e.client, opts)
}

func (e *ModelEntity) Data(args ...any) any {
...
func (e *ModelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ModelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ModelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ModelEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *ModelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ModelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ModelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ModelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
