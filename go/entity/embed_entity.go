...
func NewEmbedEntity(client *core.UnivecSDK, entopts map[string]any) *EmbedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmbedEntity) GetName() string { return e.name }
...
func (e *EmbedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmbedEntity) Deleted() bool {
	return e.deleted
}


func (e *EmbedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmbedEntity(e.client, opts)
}

func (e *EmbedEntity) Data(args ...any) any {
...
func (e *EmbedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Embed; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EmbedEntity) DataTyped(data ...Embed) Embed {
	if len(data) > 0 {
		return typedFrom[Embed](e.Data(asMap(data[0])))
	}
	return typedFrom[Embed](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Embed (all fields
// optional at the wire level).
func (e *EmbedEntity) MatchTyped(match ...Embed) Embed {
	if len(match) > 0 {
		return typedFrom[Embed](e.Match(asMap(match[0])))
	}
	return typedFrom[Embed](e.Match())
}
...
func (e *EmbedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmbedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EmbedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EmbedEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EmbedCreateData and returns an Embed. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EmbedEntity) CreateTyped(reqdata EmbedCreateData, ctrl map[string]any) (Embed, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Embed{}, err
	}
	return typedFrom[Embed](res), nil
}



func (e *EmbedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmbedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmbedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
