...
func NewConvertEntity(client *core.UnivecSDK, entopts map[string]any) *ConvertEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConvertEntity) GetName() string { return e.name }
...
func (e *ConvertEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConvertEntity) Deleted() bool {
	return e.deleted
}


func (e *ConvertEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConvertEntity(e.client, opts)
}

func (e *ConvertEntity) Data(args ...any) any {
...
func (e *ConvertEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Convert; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConvertEntity) DataTyped(data ...Convert) Convert {
	if len(data) > 0 {
		return typedFrom[Convert](e.Data(asMap(data[0])))
	}
	return typedFrom[Convert](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Convert (all fields
// optional at the wire level).
func (e *ConvertEntity) MatchTyped(match ...Convert) Convert {
	if len(match) > 0 {
		return typedFrom[Convert](e.Match(asMap(match[0])))
	}
	return typedFrom[Convert](e.Match())
}
...
func (e *ConvertEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConvertEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConvertCreateData and returns an Convert. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ConvertEntity) CreateTyped(reqdata ConvertCreateData, ctrl map[string]any) (Convert, error) {
...
func (e *ConvertEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConvertEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConvertEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
