...
const testSeed = `map[string]any{"entity": map[string]any{"convert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "embed": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ephemeral_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "model": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
