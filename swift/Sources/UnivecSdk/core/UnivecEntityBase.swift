// UnivecEntityBase - shared entity behaviour: construction, data/match
...
open class UnivecEntityBase: Entity {
  var name: String
  var client: UnivecSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: UnivecSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return UnivecEntityBase(client, cloneOpts(), name)
  }
