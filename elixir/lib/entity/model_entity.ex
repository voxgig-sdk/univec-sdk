...
defmodule Univec.Entity.Model do
  ...
  # Returns a list of model entity maps (Univec.Types.model/0)
  ...
  @spec list(map(), Univec.Types.model_list_match() | nil, map() | nil) :: term()
