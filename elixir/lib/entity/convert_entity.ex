...
defmodule Univec.Entity.Convert do
  ...
  # Returns the created convert entity map (Univec.Types.convert/0)
  ...
  @spec create(map(), Univec.Types.convert_create_data() | nil, map() | nil) :: term()
