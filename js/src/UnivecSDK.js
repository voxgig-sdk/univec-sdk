...
const { ConvertEntity } = require('./entity/ConvertEntity')
const { EmbedEntity } = require('./entity/EmbedEntity')
const { EphemeralKeyEntity } = require('./entity/EphemeralKeyEntity')
const { ModelEntity } = require('./entity/ModelEntity')
...
const { UnivecEntityBase } = require('./UnivecEntityBase')
...
class UnivecSDK {
  ...
  Convert(entopts) {
    const self = this
    return new ConvertEntity(self, entopts)
  }
  ...
  Embed(entopts) {
    const self = this
    return new EmbedEntity(self, entopts)
  }
