...
runtime for the `streaming` feature in the JavaScript target — do
...
| Runtime template | `.sdk/tm/js/src/feature/streaming/` (copied here on `generate`; `FEATURE_Name`/`FEATURE_VERSION` substituted) |
...
- **Behaviour**: edit the runtime template under
  `.sdk/tm/js/src/feature/streaming/`, then regenerate.
