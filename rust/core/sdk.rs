// UnivecSDK client (generated — mirrors the go Main fragment).
...
use crate::core::error::UnivecError;
...
impl UnivecSDK {
    pub fn new(options: Value) -> Rc<UnivecSDK> {
        let sdk = Rc::new(UnivecSDK {
    ...
    pub fn prepare(&self, fetchargs: Value) -> Result<Value, UnivecError> {
    ...
    pub fn direct(&self, fetchargs: Value) -> Result<Value, UnivecError> {
    ...
    fn op_denied(&self, op: &str) -> Value {
        ...
        jo(vec![
            ...
            ("err", Value::str(format!(
                "UnivecSDK: {}: operation not allowed by SDK option \
    ...
    // gate by passing it.
    fn raw_request(&self, fetchargs: Value) -> Result<Value, UnivecError> {
        let utility = &self.utility;
    ...
    pub fn graphql(
        ...
        if let Value::List(items) = &errors {
            ...
            if let Some(first) = first {
                ...
                setp(&res, "err",
                     Value::str(format!("UnivecSDK: graphql: {}", msg)));
    ...
    pub fn convert(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::convert::ConvertEntity> {
        crate::entity::convert::ConvertEntity::new(self, entopts)
    }

    /// Embed entity bound to this client.
    pub fn embed(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::embed::EmbedEntity> {
        crate::entity::embed::EmbedEntity::new(self, entopts)
    }

    /// EphemeralKey entity bound to this client.
    pub fn ephemeral_key(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::ephemeral_key::EphemeralKeyEntity> {
        crate::entity::ephemeral_key::EphemeralKeyEntity::new(self, entopts)
    }

    /// Model entity bound to this client.
    pub fn model(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::model::ModelEntity> {
        crate::entity::model::ModelEntity::new(self, entopts)
    }

}

pub fn test_sdk(testopts: Value, sdkopts: Value) -> Rc<UnivecSDK> {
