// Univec SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::UnivecError;
...
pub use crate::core::sdk::{test_sdk, UnivecSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, UnivecEntity,
};
...
// No-argument convenience constructors: `univec_sdk::new()` /
// `univec_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<UnivecSDK> {
    UnivecSDK::new(Value::Noval)
}

pub fn test() -> Rc<UnivecSDK> {
