// Convert entity client (generated — mirrors the go Entity fragment).
...
impl ConvertEntity {
    pub fn new(client: &Rc<UnivecSDK>, entopts: Value) -> Rc<ConvertEntity> {
...
impl Entity for ConvertEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ConvertEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl UnivecEntity for ConvertEntity {
