// Embed entity client (generated — mirrors the go Entity fragment).
...
impl EmbedEntity {
    pub fn new(client: &Rc<UnivecSDK>, entopts: Value) -> Rc<EmbedEntity> {
...
impl Entity for EmbedEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        EmbedEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl UnivecEntity for EmbedEntity {
