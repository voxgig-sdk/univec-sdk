// Univec SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'UnivecSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['Convert', 'Embed', 'EphemeralKey', 'Model'];
