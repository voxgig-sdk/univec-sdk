...
// Typed models: see ../UnivecTypes.dart (Embed and the per-op request/match types).
class EmbedEntity extends UnivecEntityBase {
  EmbedEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'embed';
    name_ = 'embed';
    Name = 'Embed';
  }
  ...
  EmbedEntity make() {
    return EmbedEntity(client, entopts());
  }




  /// Create a Embed (see EmbedCreateData in
  /// UnivecTypes.dart). Returns the entity data map (Embed).
