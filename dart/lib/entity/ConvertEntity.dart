...
// Typed models: see ../UnivecTypes.dart (Convert and the per-op request/match types).
class ConvertEntity extends UnivecEntityBase {
  ConvertEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'convert';
    name_ = 'convert';
    Name = 'Convert';
  }
  ...
  ConvertEntity make() {
    return ConvertEntity(client, entopts());
  }




  /// Create a Convert (see ConvertCreateData in
  /// UnivecTypes.dart). Returns the entity data map (Convert).
