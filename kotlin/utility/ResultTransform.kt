...
fun resultBasic(ctx: Context): voxgig.univecsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.univecsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.univecsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
