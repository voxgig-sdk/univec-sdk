...
class ModelEntity extends UnivecEntityBase_1.UnivecEntityBase {
    ...
    make() {
        return new ModelEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Model[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=ModelEntity.js.map