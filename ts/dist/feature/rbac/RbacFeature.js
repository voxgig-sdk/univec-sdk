...
class RbacFeature extends BaseFeature_1.BaseFeature {
    version = '0.0.1';
    name = 'rbac';
    active = true;
    _client;
    ...
    _reject(ctx, required) {
        ...
        const err = ctx.error('rbac_denied', 'Permission "' + required + '" required for operation "' +
            ((ctx.op && ctx.op.name) || '?') + '"');
...
exports.RbacFeature = RbacFeature;
//# sourceMappingURL=RbacFeature.js.map