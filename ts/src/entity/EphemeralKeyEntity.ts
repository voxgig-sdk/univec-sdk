...
class EphemeralKeyEntity extends UnivecEntityBase<EphemeralKey> {
  ...
  async create(this: any, reqdata?: EphemeralKeyCreateData, ctrl?: Control): Promise<EphemeralKeyEntity> {
