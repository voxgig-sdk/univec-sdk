...
object Config {
  ...
  def featurePlugins(name: String): List[Any] = name match {
    case "secrets" => List(com.voxgig.sekreto.plugins.boru, com.voxgig.sekreto.plugins.hashicorp)
    case _ => Nil
  }

  def makeFeature(name: String): Feature = name match {
    case "audit" => new voxgig.univecsdk.feature.AuditFeature()
    case "cache" => new voxgig.univecsdk.feature.CacheFeature()
    case "clienttrack" => new voxgig.univecsdk.feature.ClienttrackFeature()
    case "cost" => new voxgig.univecsdk.feature.CostFeature()
    case "debug" => new voxgig.univecsdk.feature.DebugFeature()
    case "idempotency" => new voxgig.univecsdk.feature.IdempotencyFeature()
    case "log" => new voxgig.univecsdk.feature.LogFeature()
    case "metrics" => new voxgig.univecsdk.feature.MetricsFeature()
    case "netsim" => new voxgig.univecsdk.feature.NetsimFeature()
    case "paging" => new voxgig.univecsdk.feature.PagingFeature()
    case "proxy" => new voxgig.univecsdk.feature.ProxyFeature()
    case "ratelimit" => new voxgig.univecsdk.feature.RatelimitFeature()
    case "rbac" => new voxgig.univecsdk.feature.RbacFeature()
    case "retry" => new voxgig.univecsdk.feature.RetryFeature()
    case "secrets" => new voxgig.univecsdk.feature.SecretsFeature()
    case "streaming" => new voxgig.univecsdk.feature.StreamingFeature()
    case "telemetry" => new voxgig.univecsdk.feature.TelemetryFeature()
    case "test" => new voxgig.univecsdk.feature.TestFeature()
    case "timeout" => new voxgig.univecsdk.feature.TimeoutFeature()
    case _ => new voxgig.univecsdk.feature.BaseFeature()
  }
  ...
  private def configJson(): String = {
    ...
    b.append("        \"assert\": {")
    b.append("         \"equal\": {")
    b.append("          \"source_model\": {")
    b.append("           \"from\": \"models\",")
    b.append("           \"path\": \"sourceModel\",")
    b.append("           \"related\": {")
    b.append("            \"foreign\": \"name\",")
    b.append("            \"from\": \"models\",")
    b.append("            \"local\": \"sourceModel\",")
    b.append("            \"where\": {")
    b.append("             \"modelType\": \"embed\"")
    b.append("            }")
    b.append("           },")
    b.append("           \"where\": {")
    b.append("            \"modelType\": \"convert\"")
    b.append("           }")
    b.append("          },")
    b.append("          \"target_model\": {")
    b.append("           \"from\": \"models\",")
    b.append("           \"path\": \"targetModel\",")
    b.append("           \"related\": {")
    b.append("            \"foreign\": \"name\",")
    b.append("            \"from\": \"models\",")
    b.append("            \"local\": \"sourceModel\",")
    ...
    b.append("           }")
    b.append("          },")
    b.append("          \"path\": \"embeddings\"")
    b.append("         }")
    b.append("        },")
    b.append("        \"auth\": \"account\",")
    b.append("        \"id\": \"account-convert\",")
    b.append("        \"input\": {")
    b.append("         \"embeddings\": {")
    b.append("          \"from\": \"account-embed\",")
    b.append("          \"path\": \"embeddings\"")
    b.append("         },")
    b.append("         \"source_model\": {")
    b.append("          \"from\": \"models\",")
    ...
    b.append("        },")
    b.append("        \"auth\": \"account\",")
    b.append("        \"id\": \"account-embed-bridge\",")
    b.append("        \"input\": {")
    b.append("         \"bridge_model\": {")
    b.append("          \"from\": \"models\",")
    b.append("          \"path\": \"sourceModel\",")
    ...
    b.append("         },")
    b.append("         \"texts\": [")
    b.append("          \"SDK live coverage test.\"")
    b.append("         ]")
    b.append("        }")
    b.append("       },")
    b.append("       \"method\": \"POST\",")
    ...
    b.append("         }")
    b.append("        },")
    b.append("        \"auth\": \"issued\",")
    b.append("        \"credential\": {")
    b.append("         \"from\": \"key\",")
    b.append("         \"path\": \"key\"")
    b.append("        },")
    b.append("        \"id\": \"ephemeral-convert\",")
    b.append("        \"input\": {")
    b.append("         \"embeddings\": {")
    b.append("          \"from\": \"ephemeral-embed\",")
    b.append("          \"path\": \"embeddings\"")
    b.append("         },")
    b.append("         \"source_model\": {")
    b.append("          \"from\": \"models\",")
    ...
    b.append("         \"path\": \"key\"")
    b.append("        },")
    b.append("        \"id\": \"ephemeral-embed-bridge\",")
    b.append("        \"input\": {")
    b.append("         \"bridge_model\": {")
    b.append("          \"from\": \"models\",")
    b.append("          \"path\": \"sourceModel\",")
    ...
    b.append("         ]")
    b.append("        },")
    b.append("        \"auth\": \"public\",")
    b.append("        \"id\": \"key\",")
    b.append("        \"retention\": \"No deletion endpoint; issued key is subject to the service daily allowance\"")
    b.append("       },")
    b.append("       \"method\": \"POST\",")
