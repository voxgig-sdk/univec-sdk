...
class EmbedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmbedEntity($this->_client, $opts);
    }

    /**
     * @param Embed|array $args Embed data (assoc-array) to store.
     */
    ...
    /**
     * @return Embed|array The current Embed data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Embed fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Embed fields).
     */
     ...
     * Create a new Embed.
     *
     * @param EmbedCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmbedCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Embed|array The created Embed as an assoc-array at the
