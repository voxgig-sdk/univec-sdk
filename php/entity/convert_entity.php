...
class ConvertEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConvertEntity($this->_client, $opts);
    }

    /**
     * @param Convert|array $args Convert data (assoc-array) to store.
     */
    ...
    /**
     * @return Convert|array The current Convert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Convert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Convert fields).
     */
     ...
     *
     * @param ConvertCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConvertCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Convert|array The created Convert as an assoc-array at the
