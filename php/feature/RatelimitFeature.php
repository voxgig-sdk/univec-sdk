...
class UnivecRatelimitFeature extends UnivecBaseFeature
{
    ...
    private function _acquire(UnivecContext $ctx): void
    {
    ...
    private function _track(UnivecContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
