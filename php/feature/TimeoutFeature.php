...
class UnivecTimeoutFeature extends UnivecBaseFeature
{
    ...
    private function _with_timeout(UnivecContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UnivecContext $_ctx, float $ms): void
    {
        $client = $this->client;
