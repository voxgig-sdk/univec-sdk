...
class UnivecRbacFeature extends UnivecBaseFeature
{
    ...
    private function _required(UnivecContext $ctx): ?string
    {
    ...
    private function _reject(UnivecContext $ctx, string $required): void
    {
    ...
    private function _track(UnivecContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
