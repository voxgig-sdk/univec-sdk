...
class UnivecTestRunner
{
    ...
    {
        $live = self::getenv('UNIVEC_TEST_LIVE');
        $override = self::getenv('UNIVEC_TEST_OVERRIDE');
        ...
        $explain = self::getenv('UNIVEC_TEST_EXPLAIN');
...
class_alias('UnivecTestRunner', 'Runner');
class_alias('UnivecHelpers', 'Helpers');
